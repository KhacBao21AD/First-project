...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 21, 2022 lúc 09:49 AM
...
(1, 'TEST NAME', 'a description', 'logo.png'),
...
(10, 'TEST UPDATE', 'Descriptionaa', 'tureaa.gif');
...
('AAA', 'AAA', 'CONTACT NAME', '', 'ADDRESS', 'CITY', '', '100000', 'VIETNAM', '', ''),
...
(12, 'AAA', 'AAA', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'DA NANG', '', '', '', '', '', '', 'PHOTO', 'NOTE', NULL),
(13, 'AAA', 'AAA', '', '', '2022-10-10 00:00:00', '0000-00-00 00:00:00', 'DA NANG', '', '', '', '', '', '', 'PHOTO', 'NOTE', NULL);
...
(10248, 'TOMSP', 5, '1996-07-04 00:00:00', '1996-08-01 00:00:00', '1996-07-16 00:00:00', 3, 32.38, 'Vins et alcools Chevalier', '59 rue de l\'Abbaye', 'Reims', '', '51100', 'France'),
...
(10250, 'HANAR', 4, '1996-07-08 23:00:00', '1996-08-05 00:00:00', '1996-07-12 00:00:00', 2, 65.83, 'Hanari Carnes', 'Rua do Paço, 67', 'Rio de Janeiro', 'RJ', '05454-876', 'Brazil'),
...
(11082, 'FRANK', 1, '2022-10-30 14:41:32', NULL, NULL, 1, 0, '', 'VKU', 'Đà Nẵng', 'Miền Trung', '100000', 'Việt Nam'),
(11083, 'FRANK', 1, '2022-10-30 16:11:37', NULL, NULL, 1, 0, '', 'VKU', 'Đà Nẵng', 'Miền Trung', '100000', 'Việt Nam'),
(11084, 'FRANK', 1, '2022-10-30 16:13:40', NULL, NULL, 1, 0, '', 'VKU', 'Đà Nẵng', 'Miền Trung', '100000', 'Việt Nam'),
(11085, 'FRANK', 1, '2022-10-30 16:15:13', NULL, NULL, 1, 0, '', 'VKU', 'Đà Nẵng', 'Miền Trung', '100000', 'Việt Nam'),
(11086, 'FRANK', 1, '2022-10-30 16:16:02', NULL, NULL, 1, 0, '', 'VKU', 'Đà Nẵng', 'Miền Trung', '100000', 'Việt Nam'),
(11087, 'FRANK', 1, '2022-10-30 16:17:21', NULL, NULL, 1, 0, '', 'VKU', 'Đà Nẵng', 'Miền Trung', '100000', 'Việt Nam');
...
(2157, 10248, 12, 0, 1, 0),
(2158, 11082, 11, 14, 20, 0),
(2159, 11086, 11, 21, 10, 0),
(2160, 11086, 14, 23.25, 20, 0),
(2161, 11086, 15, 15.5, 5, 0),
(2162, 11087, 11, 21, 10, 0),
(2163, 11087, 14, 23.25, 20, 0),
(2164, 11087, 15, 15.5, 5, 0);
...
(1, 'TEST NAME', 1, 1, '10 boxes x 20 bags', 18, 39, 0, 10, 'n'),
...
(1, 'test name company', '0123'),
(2, 'United Package', '(503) 555-3199'),
(3, 'Federal Shipping', '(503) 555-9931'),
(5, 'test update 2', '0898'),
(8, 'shipper4', '08980');
...
(1, 'COMPANY NAME', 'Charlotte Cooper', 'Purchasing Manager', '49 Gilbert St.', 'London', '', 'EC1 4SD', 'UK', '(171) 555-2222', '', ''),
...
(32, 'test update', 'TEST', '', 'Address', 'City', '', '100000', 'Country', '123422', '', '');

-- --------------------------------------------------------

--
-- Cấu trúc đóng vai cho view `vw10most_expensive_products`
...
--
-- Cấu trúc đóng vai cho view `vwcustomer_supplier_by_city`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `vwinvoice`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `vwproducts_above_average_price`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `vwquarterly_orders_by_product`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `vwsales_by_category`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `vwunits_in_stock`
-- (See below for the actual view)
--
...
--
-- Cấu trúc cho view `vw10most_expensive_products`
--
DROP TABLE IF EXISTS `vw10most_expensive_products`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw10most_expensive_products`  AS SELECT DISTINCT `products`.`ProductName` AS `Ten_Most_Expensive_Products`, `products`.`UnitPrice` AS `UnitPrice` FROM `products` ORDER BY `products`.`UnitPrice` DESC LIMIT 0, 1010  ;

-- --------------------------------------------------------

--
-- Cấu trúc cho view `vwcustomer_supplier_by_city`
--
...
--
ALTER TABLE `categories`
  MODIFY `CategoryID` tinyint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `employees`
--
ALTER TABLE `employees`
  MODIFY `EmployeeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `orders`
--
ALTER TABLE `orders`
  MODIFY `OrderID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11088;
...
--
ALTER TABLE `shippers`
  MODIFY `ShipperID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `suppliers`
--
ALTER TABLE `suppliers`
  MODIFY `SupplierID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
